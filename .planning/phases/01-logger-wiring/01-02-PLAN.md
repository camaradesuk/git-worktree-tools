...
must_haves:
  ...
  artifacts:
    ...
    - path: 'src/cli/wtlink.ts'
      provides: 'initializeLogger call via yargs middleware'
      contains: 'initializeLogger'
    - path: 'src/cli/wt/new.ts'
      provides: 'flag forwarding to newpr child process'
      contains: "'--verbose'"
    - path: 'src/cli/wt/run-command.ts'
      provides: 'runSubcommand with env overrides support'
