...
Check what the default command in wtlink.ts does -- it likely calls the manage-manifest interactive mode or a main menu. Look at `src/lib/wtlink/main-menu.ts` for the entry point.
